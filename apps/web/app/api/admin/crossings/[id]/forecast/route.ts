    ...
    try {
      ...
      for (const rule of rules) {
        ...
        for (const train of scopedRegistry) {
          ...
          if (!matchesCorridor(train.route || [], rule.observationStation, infrastructureRefs)) continue;
