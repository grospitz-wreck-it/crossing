  ...
  return (
    <main className={styles.page}>
      <header className={styles.header}>
        <Link href="/" className={styles.logoLink} aria-label="MeineSchranke Startseite"><Image src="/images/meineschranke_logo.webp" alt="meineschranke" width={236} height={64} priority className={styles.logo} /></Link>
      ...
      <footer className={styles.footer}><div className={styles.footerBrand}><Image src="/images/meineschranke_logo.webp" alt="meineschranke" width={190} height={52} /><p>Digitale Schrankensteuerung<br />für smarte Standorte und<br />moderne Gemeinden.</p></div><div><b>NAVIGATION</b><a href="#funktionen">Funktionen</a><a href="#so-funktionierts">So funktioniert&apos;s</a><a href="#medien">Über uns</a><a href="#faq">FAQ</a></div><div><b>RECHTLICHES</b><a href="https://www.pxxl.com/privacy">Datenschutz</a><a href="https://www.pxxl.com/imprint">Impressum</a></div><div><b>KONTAKT</b><a href="mailto:info@meineschranke.de">info@meineschranke.de</a><span className={styles.socials}>◎　✉</span></div><small className={styles.copyright}>© 2026 MeineSchranke. Ein Angebot der pxxl productions UG (haftungsbeschränkt).</small></footer>
    </main>
  );
}
