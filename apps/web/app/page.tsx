...
const features = [
  ...
  { number: "03", icon: "◌", title: "Das System lernt mit", text: "Bewerte Prognosen direkt in der App. Deine Rückmeldung hilft dabei, die Vorhersagen kontinuierlich zu verbessern." },
];
