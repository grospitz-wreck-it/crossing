  ...
  return (
    <main className={styles.page}>
      <header className={styles.header}>
        <Link href="/" className={styles.logoLink} aria-label="MeineSchranke Startseite"><Image src="/images/meineschranke_logo.webp" alt="meineschranke" width={236} height={64} priority className={styles.logo} style={{ width: "clamp(185px, 16vw, 225px)" }} /></Link>
        <nav className={styles.nav} aria-label="Hauptnavigation"><a href="#funktionen">Funktionen</a><a href="#so-funktionierts">So funktioniert&apos;s</a><a href="#medien">Über uns</a><a href="#faq">FAQ</a></nav>
      ...
      <section id="so-funktionierts" className={styles.section}><div className={styles.sectionIntro}><p className={styles.eyebrow}>SO FUNKTIONIERT&apos;S</p><h2>Du willst wissen,<br /><em>wann du weiterfahren kannst?</em></h2><p>MeineSchranke macht aus Fahrplan- und verfügbaren Echtzeitinformationen eine verständliche Prognose für deinen Bahnübergang.</p></div><div className={styles.steps}><article><span>01</span><div className={styles.stepIcon}>⌖</div><h3>Schranke wählen</h3><p>Wähle den Bahnübergang, der für dich relevant ist.</p></article><article><span>02</span><div className={styles.stepIcon}>◷</div><h3>Prognose ansehen</h3><p>Sieh auf einen Blick, wann die nächste Schließung erwartet wird.</p></article><article><span>03</span><div className={styles.stepIcon}>✓</div><h3>Weiterfahren</h3><p>Plane deine Fahrt besser und vermeide unnötige Wartezeit.</p></article></div></section>
      ...
      <footer className={styles.footer}><div className={styles.footerBrand}><Image src="/images/meineschranke_logo.webp" alt="meineschranke" width={190} height={52} /><p>Digitale Schrankensteuerung<br />für smarte Standorte und<br />moderne Gemeinden.</p></div><div><b>NAVIGATION</b><a href="#funktionen">Funktionen</a><a href="#so-funktionierts">So funktioniert&apos;s</a><a href="#medien">Über uns</a><a href="#faq">FAQ</a></div><div><b>RECHTLICHES</b><Link href="/privacy">Datenschutz</Link><Link href="/imprint">Impressum</Link></div><div><b>KONTAKT</b><a href="mailto:info@meineschranke.de">info@meineschranke.de</a><span className={styles.socials}>◎　✉</span></div><small className={styles.copyright}>© 2026 MeineSchranke. Ein Angebot der pxxl productions UG (haftungsbeschränkt).</small></footer>
    </main>
  );
}
