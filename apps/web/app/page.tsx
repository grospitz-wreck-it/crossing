  ...
  return (
    <main className={styles.page}>
      <header className={styles.header}>
        <Link href="/" className={styles.logoLink} aria-label="MeineSchranke Startseite"><Image src="/images/meineschranke_logo.webp" alt="meineschranke" width={236} height={64} priority className={styles.logo} style={{ width: 225 }} /></Link>
