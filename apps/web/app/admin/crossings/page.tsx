...
export default function CrossingsAdmin() {
  const [crossings, setCrossings] = useState<Crossing[]>([]), [open, setOpen] = useState(false), [saving, setSaving] = useState(false), [coords, setCoords] = useState(""), [nearest, setNearest] = useState<any[]>([]), [location, setLocation] = useState<any>(null), [lookupError, setLookupError] = useState("");
  ...
  async function save() {
    ...
    try {
      ...
      await load(); setOpen(false); setNearest([]); setLocation(null); setCoords("");
