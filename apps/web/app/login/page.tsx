    ...
    <main className="loginPageNew">
      ...
      <section className="loginShell">
        ...
        <div className="loginCardNew">
          <div className="loginEyebrow">DEINE PERSÖNLICHE SCHRANKE</div>

          <h1>
            Willkommen bei<br />
            <span>meineschranke.</span>
          </h1>

          <p className="loginLead">
            Melde dich an, um deine persönliche Schranke zu speichern
            und die Prognosen für Kirchlengern zu nutzen.
          </p>
          ...
          <div className="loginDivider"><span>oder</span></div>

          <div className="loginHintNew">
            Weitere Anmeldeoptionen folgen.
          </div>

          <a href="/" className="loginBackNew">
            ← Zur Startseite
          </a>
        </div>

        <p className="loginLegal">
          Mit der Anmeldung stimmst du den geltenden Datenschutzbestimmungen zu.
        </p>
      </section>
    </main>
  );
